        ...
        <Card>
          <div style={{ display: "grid", gap: 12 }}>
            ...
            <div style={{ padding: "0 14px 14px" }}>
              ...
              >
                <div>
                  <div style={{ color: "var(--text-muted)", fontWeight: 700, fontSize: 12 }}>Preço</div>
                  <div style={{ fontWeight: 900 }}>{brl.format(product.price)}</div>
                </div>
                <div>
                  <div style={{ color: "var(--text-muted)", fontWeight: 700, fontSize: 12 }}>Rendimento diário</div>
                  <div style={{ fontWeight: 900 }}>{brl.format(product.dailyYield)}</div>
                </div>
                <div>
                  <div style={{ color: "var(--text-muted)", fontWeight: 700, fontSize: 12 }}>Ciclo</div>
                  <div style={{ fontWeight: 900 }}>
                    {product.cycleDays} {product.cycleDays === 1 ? "dia" : "dias"}
                  </div>
                </div>
                <div>
                  <div style={{ color: "var(--text-muted)", fontWeight: 700, fontSize: 12 }}>Retorno total</div>
