import { AdminGatewaySettingsForm } from "@/components/admin/AdminGatewaySettingsForm";
...
export default async function AdminSettingsPage() {
  ...
  return (
    <>
      <AdminGatewaySettingsForm />
      <AdminPlatformSettingsForm
      initial={{
        minDeposit: Number(s.minDeposit) || 10,
        minWithdrawal: Number(s.minWithdrawal) || 20,
        initialUserBalance: Number.isFinite(Number(s.initialUserBalance))
          ? Number(s.initialUserBalance)
          : 0,
