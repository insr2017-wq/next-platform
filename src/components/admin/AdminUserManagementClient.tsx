    ...
    <>
      ...
      <section style={cardStyle}>
        ...
        >
          ...
          <div>
            ...
            <span style={{ color: user.banned ? "var(--danger)" : "var(--brand)", fontWeight: 700 }}>
        ...
        {saveMsg && (
          <div
            style={{
              ...
              padding: 10,
              borderRadius: 10,
              background: saveMsg.type === "ok" ? "var(--brand-light)" : "rgba(248,113,113,0.14)",
              color: saveMsg.type === "ok" ? "var(--brand)" : "var(--danger)",
              fontSize: 13,
              fontWeight: 600,
            }}
          >
        ...
        {balanceMsg && (
          <div
            style={{
              ...
              fontSize: 12,
              fontWeight: 700,
              color: balanceMsg.type === "ok" ? "var(--brand)" : "var(--danger)",
            }}
          >
            {balanceMsg.text}
          </div>
        ...
        {assignMsg && (
          <div
            style={{
              ...
              fontSize: 12,
              fontWeight: 700,
              color: assignMsg.type === "ok" ? "var(--brand)" : "var(--danger)",
            }}
          >
            {assignMsg.text}
          </div>
        ...
        {pixMsg && (
          <div
            style={{
              ...
              fontSize: 13,
              fontWeight: 600,
              color: pixMsg.type === "ok" ? "var(--brand)" : "var(--danger)",
            }}
          >
            {pixMsg.text}
          </div>
      ...
      <section style={cardStyle}>
        ...
        {deleteConfirm ? (
          ...
          >
            <p style={{ margin: "0 0 10px", fontSize: 14, fontWeight: 700, color: "var(--danger)" }}>
