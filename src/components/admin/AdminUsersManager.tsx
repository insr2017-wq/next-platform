      ...
      {bulkMsg ? (
        <div
          style={{
            ...
            fontSize: 12,
            fontWeight: 700,
            background: bulkMsg.type === "ok" ? "var(--brand-light)" : "rgba(248,113,113,0.14)",
            color: bulkMsg.type === "ok" ? "var(--brand)" : "var(--danger)",
            border: bulkMsg.type === "ok" ? "1px solid var(--brand-border)" : "1px solid rgba(248,113,113,0.35)",
          }}
        >
          {bulkMsg.text}
        </div>
            ...
            <tr key={u.id} style={{ borderBottom: "1px solid var(--border)" }}>
              ...
              <td style={{ padding: "10px 8px", fontSize: 13 }}>
                <span
                  style={{
                    fontWeight: 700,
                    color: u.banned ? "var(--danger)" : "var(--brand)",
                  }}
                >
