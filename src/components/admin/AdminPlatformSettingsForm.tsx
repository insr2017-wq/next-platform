...
export function AdminPlatformSettingsForm({ initial }: Props) {
  ...
  const [initialUserBalance, setInitialUserBalance] = useState(
    toInput(initial?.initialUserBalance)
  );
    ...
    try {
      const res = await fetch("/api/admin/platform-settings", {
        ...
        body: JSON.stringify({
          ...
          initialUserBalance: initialUserBalance.replace(",", "."),
      ...
      if (fresh.minDeposit != null) {
        ...
        if (fresh.initialUserBalance != null) setInitialUserBalance(toInput(fresh.initialUserBalance));
  ...
  return (
    ...
    >
      ...
      <p style={{ margin: "0 0 20px", fontSize: 13, color: "var(--text-muted)" }}>
        Estes valores serão usados em depósitos, saques, saldo inicial de novos cadastros e comissões de indicação (níveis 1 a 3).
      </p>
      ...
      <div style={{ display: "grid", gap: 16 }}>
        ...
        <label style={{ display: "grid", gap: 6 }}>
          <span style={{ fontSize: 13, fontWeight: 700, color: "var(--text)" }}>
            Saldo inicial de novos usuários (R$)
          </span>
          <input
          ...
          />
          <span style={{ fontSize: 12, color: "var(--text-muted)", fontWeight: 600, lineHeight: 1.4 }}>
            Valor creditado só no cadastro. Contas já existentes não são alteradas.
          </span>
        </label>
        ...
        <label style={{ display: "grid", gap: 6 }}>
          <span style={{ fontSize: 13, fontWeight: 700, color: "var(--text)" }}>Nível 2</span>
          <input
            value={c2}
        ...
        <label style={{ display: "grid", gap: 6 }}>
          <span style={{ fontSize: 13, fontWeight: 700, color: "var(--text)" }}>Nível 3</span>
          <input
            value={c3}
        ...
        >
          ...
          <label style={{ display: "grid", gap: 6 }}>
            <span style={{ fontSize: 12, fontWeight: 900, color: "var(--text)" }}>Link do grupo</span>
            <input
          ...
          <div style={{ fontSize: 12, color: "var(--text-muted)", fontWeight: 700, lineHeight: 1.4 }}>
            ...
            <label style={{ display: "grid", gap: 6, opacity: earningsTestMode ? 1 : 0.6 }}>
              ...
              <input
                ...
                style={{
                  ...
                  border: "1px solid var(--border)",
                  fontSize: 15,
                  background: !earningsTestMode ? "var(--surface-soft)" : "var(--surface)",
                }}
              />
            </label>
          </div>
