              ...
              {rows.map((r) => (
                <tr key={r.id} style={{ borderBottom: "1px solid var(--border)" }}>
                  ...
                  <td style={{ padding: "8px 6px" }}>
                    <span style={{ color: r.isActive ? "var(--brand)" : "var(--text-muted)", fontWeight: 700 }}>
      ...
      {deleteId && !mode ? (
        <>
          ...
          >
            ...
            {error ? (
              <p style={{ color: "var(--danger)", fontWeight: 600, fontSize: 13 }}>{error}</p>
            ) : null}
          ...
          >
            ...
            <form onSubmit={handleSubmit} style={{ display: "grid", gap: 12 }}>
              <label style={{ display: "grid", gap: 4 }}>
                <span style={{ fontSize: 12, fontWeight: 700, color: "var(--text-muted)" }}>Código</span>
                <input
                  value={code}
