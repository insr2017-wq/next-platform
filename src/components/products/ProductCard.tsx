    ...
    >
      <div
        style={{
          ...
          height: "100%",
          background:
            "radial-gradient(circle at 20% 20%, rgba(var(--brand-rgb), 0.38), transparent 55%), radial-gradient(circle at 80% 80%, rgba(192,192,192,0.2), transparent 55%)",
          display: "flex",
          alignItems: "flex-end",
          ...
          <div style={{ padding: "0 14px 14px" }}>
            <Link
              ...
              style={{
                ...
                background: "linear-gradient(160deg, var(--accent) 0%, var(--brand-2) 100%)",
                color: "var(--on-brand)",
                borderRadius: 999,
                padding: "14px 14px",
                fontWeight: 900,
