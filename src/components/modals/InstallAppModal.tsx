    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[340px] rounded-2xl border-border bg-surface p-5">
        <DialogHeader className="items-center space-y-3">
          <img src="/nexus-mark.png" alt="Nexus Tech" className="h-12 w-12 object-contain" />
          <DialogTitle className="text-center text-sm font-black tracking-widest uppercase">
            Instalar Nexus Tech
          </DialogTitle>
        </DialogHeader>
        ...
        <button
          ...
          className="mt-1 w-full rounded-xl bg-primary py-3 text-xs font-black tracking-widest text-primary-foreground uppercase"
        >
          Entendi
        </button>
      </DialogContent>
